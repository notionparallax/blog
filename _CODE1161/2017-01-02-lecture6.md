...
That's a big and thorny question! I like to think of it as a lifecycle of sorts. Let my try an analogy and then get back to data.
...
[Claude Shannon](https://en.wikipedia.org/wiki/Claude_Shannon)[^5] (April 30, 1916 – February 24, 2001) came up with the mathematics and theory of information. This seems pretty obvious but that's the nice thing about good mathematics, it often does.
...
A special case of bar plots is the histogram. You take a continuous
