...
Github does a very nice job of showing notebooks. [Here's this week's one.](https://github.com/notionparallax/code1161base/blob/master/week6/basic_pandas.ipynb) You can go through it and
...
#### (So You’d Like To Make a Map Using Python)[{{ site.baseurl }}/assets//17/london_plaque_density.png]
