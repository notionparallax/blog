...
Because you've cloned my version of the base repo, it's got all of _my_ details in it. You need to change this to have your details. Click the pencil :pencil2: and edit `README.md` so that it's got your details.

![a screen shot of README]({{ site.baseurl }}/assets/17/fillIn.png)
...
5. Do this course: https://try.github.io to get your Git skills up to speed
