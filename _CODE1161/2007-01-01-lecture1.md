...
6. Make sure that your VM is working.
    ...
    3. ![Ubuntu home screen]({{ site.baseurl }}/assets/17/loadTerminal.png) Open a terminal window. Either do it through the top icon on the toolbar and type `terminal`, or [ctrl]+[alt]+[t]
    4. ![Empty terminal]({{ site.baseurl }}/assets/17/emptyTerminal.png) This is good, you're at the supreme controller level! Now you'll need to
    5.  
