...
## (2) Apprenticeship
Apprenticeship uses a human to assess, and then the computer tries to uncover/elicit the structure of the assessment.

With (1) there is a risk of baking in biases, or potentially cutting off a good avenue to explore. (Although this may also be a problem with (2) but it'll be easier to identify and fix in (1) so it's a trade off I guess.)
