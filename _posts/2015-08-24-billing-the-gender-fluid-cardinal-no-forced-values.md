...
[^2]: Technical: I know that this is technically incorrect, but the use of normalised tables to prefill constrained dropdowns is painfully common. I know that this problem can be caused by <em>any</em> database, but none of the others hace a mental model that <em>encourages</em> it.
